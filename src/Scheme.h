...
public:
     ...
     * @param[in] cipher(m2)
     */
    void negateAndEqual(Cipher& cipher);
     ...
     */
    Cipher addByPoly(Cipher& cipher, Message& msg);
     ...
     * normally method is used as a fast version of mult method if array cnstvec is known
     */
    void addByPolyAndEqual(Cipher& cipher, Message& msg);
    ...
    // cipher - msg
    Cipher subByPoly(Cipher& cipher, Message& msg);
    
    void subByPolyAndEqual(Cipher& cipher, Message& msg);
    
    // msg - cipher
    Cipher subByPoly2(Cipher& cipher, Message& msg);
    
    void subByPolyAndEqual2(Cipher& cipher, Message& msg);
     ...
     * @param[in] cipher(m)
     * @param[in] constant
     * @return cipher(constant - m)
     */
    Cipher subConst2(Cipher& cipher, ZZ& cnst);
    
    void subConstAndEqual(Cipher& cipher, ZZ& cnst);
    //-----------------------------------------
     ...
     * @return cipher(c_1 * m_1, ..., c_slots * m_slots)
     */
    Cipher multByPoly(Cipher& cipher, Message& msg);
     ...
     * normally method is used as a fast version of mult method if array cnstvec is known
     */
    void multByPolyAndEqual(Cipher& cipher, Message& msg);
